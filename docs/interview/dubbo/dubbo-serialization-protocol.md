...
![serialize-deserialize](../../images/interview/dubbo/serialize-deserialize.png)
...
![dubbo-keep-connection](../../images/interview/dubbo/dubbo-keep-connection.png)

而短连接，每次要发送请求之前，需要先重新建立一次连接。

![dubbo-not-keep-connection](../../images/interview/dubbo/dubbo-not-keep-connection.png)
