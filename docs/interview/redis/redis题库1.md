...
![](../../images/interview/redis/使用缓存之后.05f09010.png)
...
![try-redis](../../images/interview/redis/try-redis.png)
...
![redis list](../../images/interview/redis/redis-list.png)
...
![](../../images/interview/redis/redis事件处理器.png)
...
![redis4.0 more thread](../../images/interview/redis/redis4-more-thread.png)
...
![redis过期字典](../../images/interview/redis/redis过期时间.png)
...
![redis事务](../../images/interview/redis/redis事务.png)
...
![redis roll back](../../images/interview/redis/redis-rollBack.png)
...
![缓存穿透情况](../../images/interview/redis/6358650a9bf742838441d636430c90b9.png)
...
![](../../images/interview/redis/加入布隆过滤器后的缓存处理流程.png)
